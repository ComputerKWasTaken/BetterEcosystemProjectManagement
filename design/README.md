...
| Token | Value | Usage |
|-------|-------|-------|
| `--bd-bg-primary` | `#0f0e11` | Page canvas, deepest layer |
| `--bd-bg-secondary` | `#17161b` | Cards, panels, sidebar |
| `--bd-bg-tertiary` | `#1e1d23` | Nested cards, hover fills |
| `--bd-bg-elevated` | `#26252c` | Inputs, raised surfaces |
| `--bd-bg-active` | `#2e2d35` | Pressed / active states |
| `--bd-bg-overlay` | `rgba(15,14,17,0.85)` | Modal / sheet backdrop |
...
| `--bd-text-inverse` | `#0f0e11` | On colored backgrounds |
...
| Token | Value | Usage |
|-------|-------|-------|
| `--bd-accent-primary` | `#e8850a` | Primary brand ember-orange |
| `--bd-accent-secondary` | `#c06a00` | Darker ember (gradient end) |
| `--bd-accent-light` | `#f29520` | Hover / highlight state |
| `--bd-accent-glow` | `rgba(232,133,10,0.10)` | Ambient glow, focus rings |
| `--bd-accent-muted` | `rgba(232,133,10,0.12)` | Tinted backgrounds |
| `--bd-accent-strong` | `rgba(232,133,10,0.22)` | Hover tint / emphasis |
...
| Token | Value | Usage |
|-------|-------|-------|
| `--bd-border-subtle` | `rgba(255,255,255,0.05)` | Faintest dividers |
| `--bd-border-default` | `rgba(255,255,255,0.09)` | Standard card borders |
| `--bd-border-strong` | `rgba(255,255,255,0.15)` | Hover / emphasis |
| `--bd-border-accent` | `rgba(232,133,10,0.22)` | Brand-tinted borders |
...
| `--bd-gradient-accent-bar` | to right `accent-primary` fading to transparent | **Fading Glow** accent bar |
